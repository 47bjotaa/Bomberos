...
function AddInventoryMaterialModal({ idUbicacion, onClose, onAdded }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
      <div className="flex max-h-[86vh] w-full max-w-5xl flex-col overflow-hidden rounded-2xl border border-dark-border bg-dark-surface shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="grid min-h-[460px] grid-cols-1 overflow-hidden lg:grid-cols-[minmax(0,1fr)_minmax(360px,0.95fr)]">
          <section className="flex min-h-0 flex-col border-b border-dark-border p-5 lg:border-b-0 lg:border-r">
            <div className="relative mb-4">
              ...
              <input
                ...
                className="w-full rounded-lg border border-dark-border bg-dark-bg pl-10 pr-4 py-2 text-sm text-white outline-none transition-all placeholder:text-text-muted focus:border-brand-cyan"
