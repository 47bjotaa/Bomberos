...
function ReportsView({ palette }) {
  ...
  const downloadBajasReport = async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = `reporte-bajas-${filters.motivo.toLowerCase()}-${suffix}.pdf`;
  ...
  return (
    <div className="h-full overflow-auto p-8" style={{ background: palette.bg, color: palette.text }}>
      <div className="mx-auto max-w-6xl">
        ...
        <section className="max-w-3xl rounded-lg border p-6" style={{ borderColor: palette.borderStrong, background: palette.card }}>
